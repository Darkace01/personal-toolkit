...
function DropdownMenuTrigger({
  render,
  ...props
}: useRender.ComponentProps<typeof MenuPrimitive.Trigger> & MenuPrimitive.Trigger.Props) {
  return useRender({
